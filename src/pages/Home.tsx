...
const Index = () => {
  ...
  return (
    <>
      <h1 className="text-[var(--text-highlight)] mt-2  font-bold text-md px-2">
        Movies
      </h1>
      <div className="w-[100%] flex overflow-x-scroll flex-nowrap py-2 md:py-4 gap-2 md:gap-5 scrollbar-hide px-4 ">
        ...
        <div
          ...
          className="w-[100px]  md:w-[200px]   shrink-0 md:bg-[var(--secondary-bg)] pb-4 rounded-[10px] overflow-hidden md:shadow-sm transform transition-transform duration-200 hover:scale-105 shadow-[white] cursor-pointer flex items-center justify-center"
        >
          see more
        </div>
      </div>
      ...
      <div className="w-[100%] flex overflow-x-scroll flex-nowrap py-2 md:py-4 gap-2 md:gap-5 scrollbar-hide px-4 ">
        ...
        <div
          onClick={() => navigate("/serie")}
          className="w-[100px]  md:w-[200px] shrink-0 md:bg-[var(--secondary-bg)] pb-4 rounded-[10px] overflow-hidden md:shadow-sm transform transition-transform duration-200 hover:scale-105 shadow-[white] cursor-pointer flex items-center justify-center"
        >
          see more
        </div>
      </div>
      {genreContent.movie.length > 0 ? (
          ...
          return (
            <div key={`${index}-${title}`}>
              ...
              <div className="w-[100%] flex overflow-x-scroll flex-nowrap py-2 md:py-4 gap-2 md:gap-5 scrollbar-hide px-4 ">
                ...
                <div
                  onClick={() =>
                    navigate(`/content?id=${id}&type=movie&name=${title}`)
                  }
                  className="w-[100px]  md:w-[200px] shrink-0 md:bg-[var(--secondary-bg)] pb-4 rounded-[10px] overflow-hidden md:shadow-sm transform transition-transform duration-200 hover:scale-105 shadow-[white] cursor-pointer flex items-center justify-center"
                >
                  see more
          ...
          return (
            <div key={`${index}-${title}`}>
              ...
              <div className="w-[100%] flex overflow-x-scroll flex-nowrap py-2 md:py-4 gap-2 md:gap-5 scrollbar-hide px-4 ">
                ...
                <div
                  onClick={() =>
                    navigate(`/content?id=${id}&type=tv&name=${title}`)
                  }
                  className="w-[100px]  md:w-[200px] shrink-0 md:bg-[var(--secondary-bg)] pb-4 rounded-[10px] overflow-hidden md:shadow-sm transform transition-transform duration-200 hover:scale-105 shadow-[white] cursor-pointer flex items-center justify-center"
                >
                  see more
