...
const MovieCard = ({ content, id, poster, title, date }: MovieCardProp) => {
  ...
  return (
    <div
      ...
      className="group shrink-1 md:shrink-0 min-w-[100px] sm:min-w-[140px] md:w-[260px] lg:w-[290px] cursor-pointer"
    >
      {/* Poster Box */}
