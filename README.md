...
If you want, I can draft a concise one-page submission (for interviews) that explains which parts were AI-assisted, which were hand-refactored, and one example where you overrode an AI suggestion (e.g. auth refresh queuing).